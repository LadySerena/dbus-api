...
tls_enabled=$(curl http://metadata.google.internal/computeMetadata/v1/instance/attributes/tls-enabled -H "Metadata-Flavor: Google")
...
DBUS_API_TLS_ENABLED=$tls_enabled
